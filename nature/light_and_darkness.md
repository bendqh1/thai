| English                 | Thai                   |
| ----------------------- | ---------------------- |
| Black and White         | ขาวดำ                  |
| Grey                    | สีเทา                  |
| Color                   | สี                     |
| Light                   | แสง                    |
| Shadow                  | เงา                    |
| A beam of light         | ลำแสง                  |
| Hue                     | เฉดสี                  |
| Brightness              | ความสว่าง              |
| Warmth                  | ความอบอุ่นของแสง       |
| Light and shadow        | แสงและเงา              |
| Bright                  | สว่าง                  |
| Dark                    | มืด                    |
| Bright and dark         | สว่างและมืด            |
| Shade                   | ร่มเงา                 |
| Shadowy                 | มืดเป็นเงา             |
| Shade and shadowy       | ร่มเงาและเงามืด        |
| Transparency            | ความโปร่งใส            |
| Transparent             | โปร่งใส                |
| Reflection              | การสะท้อน              |
| Reflection              | สะท้อนแสง              |
| Mirror                  | กระจก                  |
| Lightning               | ฟ้าแลบ                 |
| Daylight                | แสงวัน                 |
| Nightlight              | แสงกลางคืน             |
...
| Star light              | แสงดาว                 |
| Twilight                | พลบค่ำ                 |
| Darkness of night       | ความมืดของคืน          |
| Overnight               | ตลอดคืน                |
| Lamp light              | แสงจากโคมไฟ            |
...
* เมฆมาก ฟ้าครึ้มครึ้ม ฝนน่าจะตก คงจะมีพายุสายฟ้า
